...
The command "qcue get go" is like "go get", but converts the retrieved Go
...
The "qcue get go" command copies any cue files in the original Go package
...
Running qcue get go again to regenerate the package will never overwrite any
...
func (e *extractor) newFile(pName, args string) (*cueast.File, *cueast.Package) {
	...
	file := &cueast.File{Decls: []cueast.Decl{
		&cueast.CommentGroup{List: []*cueast.Comment{
			{Text: "// Code generated by qcue get go. DO NOT EDIT."},
		}},
		&cueast.CommentGroup{List: []*cueast.Comment{
			{Text: "//cue:generate qcue get go " + args},
		}},
		pkg,
	}}
	return file, pkg
	...
	for _, srcDir := range srcDirs {
		...
		for _, entry := range entries {
			...
			if pkg := f.PackageName(); pkg != "" && pkg == p.Name {
				w := &bytes.Buffer{}
				fmt.Fprintf(w, "// Code generated by qcue get go. DO NOT EDIT.\n\n")
				fmt.Fprintf(w, "//cue:generate qcue get go %v\n\n", args)
...
func (e *extractor) makeType2(typ types.Type, kind fieldKind, attrs fieldAttributes) (result cueast.Expr) {
	...
	case *types.Named:
		...
		case pkg.Path() == "time" && obj.Name() == "Duration":
			...
			//
			// TODO(mvdan): reconsider once 'qcue get go' is more configurable,
